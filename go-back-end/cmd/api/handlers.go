...
func (app *application) AllRatings(w http.ResponseWriter, r *http.Request) {
	genres, err := app.DB.AllRatings()
	if err != nil {
		app.errorJSON(w, err)
		return
	}
...
func (app *application) getPoster(movie models.Movie) models.Movie {
	...
	//https://api.themoviedb.org/3/search/movie?api_key=0577710a945985ce7754f0b45c02a4d2&query=Die+Hard
...
func (app *application) AllMoviesByRating(w http.ResponseWriter, r *http.Request) {
	id := chi.URLParam(r, "id")

	movies, err := app.DB.AllMoviesByRating(id)
	if err != nil {
		app.errorJSON(w, err)
		log.Println("ERROR: ", err)
		return
